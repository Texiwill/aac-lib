...
### Changelog
6.9.0 - ensured vsm.sh cannot run if update.sh is running, as well as ensured update.sh only updates when there is a new version

6.8.9 - updated how very long passwords are encoded and decoded.
